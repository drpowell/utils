...
PCA and Classical MDS are closely related.  PCA works from the original coordinate,  MDS works from a distance matrix.  If the distance matrix uses Euclidean distance, then a classical MDS and PCA produce the same projection.
